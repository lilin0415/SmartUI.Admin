...
namespace YiSha.Business.SystemManage
{
    public class DatabaseTableBLL
    {
        ...
        #region 提交数据
        public async Task<string> DatabaseBackup()
        {
            string database = GlobalContext.SystemConfig.GetDatabaseName();
            var backupPath =await databaseTableService.DatabaseBackup(database);
            return backupPath;
        }
