...
namespace YiSha.Util.Extension
{
    public static partial class Extensions
    {
        ...
        public static long ParseToLong(this object obj)
        {
            try
            {
                return DataConverter.ToLong(obj, 0).GetValueOrDefault();
        ...
        public static long ParseToLong(this string str, long defaultValue)
        {
            try
            {
                return DataConverter.ToLong(str, defaultValue).GetValueOrDefault();
            }
            catch
            {
                return defaultValue;
        ...
        public static int ParseToInt(this object str)
        {
            try
            {
                return DataConverter.ToInt(str, 0).GetValueOrDefault();
            }
            catch
            {
                return 0;
        ...
        {
            return DataConverter.ToInt(str, defaultValue).GetValueOrDefault();
