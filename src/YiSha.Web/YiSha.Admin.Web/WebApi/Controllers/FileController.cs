...
namespace YiSha.Admin.WebApi.Controllers
{
    ...
    public class FileController : ControllerBase
    {
        ...
        {
            TData<string> obj = await Util.BizFileHelper.UploadFile((UploadFileType)fileModule, fileList.Files);
            return obj;
        }
        #endregion
        ...
        {
            TData<string> obj = Util.BizFileHelper.DeleteFile(fileModule, filePath);
            return obj;
        }
        #endregion
        ...
        {
            TData<FileContentResult> obj = Util.BizFileHelper.DownloadFile(filePath, delete);
            if (obj.Status)
            {
                return obj.Result;
            }
